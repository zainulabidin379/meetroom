...
class DisapprovedTeachers extends StatefulWidget {
  const DisapprovedTeachers({Key? key}) : super(key: key);

  @override
  State<DisapprovedTeachers> createState() => _DisapprovedTeachersState();
}

class _DisapprovedTeachersState extends State<DisapprovedTeachers> {
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        Get.defaultDialog(
                          ...
                          content: Center(
                            child: Text(
                              'Are you sure to approve this teacher?',
