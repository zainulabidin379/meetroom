...
class ApprovedStudents extends StatefulWidget {
  const ApprovedStudents({Key? key}) : super(key: key);

  @override
  State<ApprovedStudents> createState() => _ApprovedStudentsState();
}

class _ApprovedStudentsState extends State<ApprovedStudents> {
                    ...
                    child: GestureDetector(
                      onTap: () async {
                        Get.defaultDialog(
                          ...
                          content: Center(
                            child: Text(
                              'Are you sure to disapprove this student?',
                            ...
                            TextButton(
                              onPressed: () async {
                                ...
                                await FirebaseFirestore.instance
                                  ...
                                  Get.snackbar(
                                    'Message',
                                    'Student profile disapproved successfully',
