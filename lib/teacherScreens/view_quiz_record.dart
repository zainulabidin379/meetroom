...
class ViewQuizRecord extends StatefulWidget {
  final String subjectCode;
  final String quizCode;
  final String quizNo;
  final String totalMarks;
  final Timestamp date;
  const ViewQuizRecord(
      {Key? key,
  ...
  @override
  State<ViewQuizRecord> createState() => _ViewQuizRecordState();
}

class _ViewQuizRecordState extends State<ViewQuizRecord> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(children: [
            Padding(
              ...
              child: Center(
                child: Text('Quiz ${widget.quizNo} Uploads',
