                              ...
                              await FirebaseFirestore.instance
                                ...
                                await FirebaseFirestore.instance
                                  ...
                                  await FirebaseFirestore.instance
                                      ...
                                      .doc(widget.subjectCode)
                                      .update({
                                    'totalQuizzes': value['totalQuizzes'] + 1,
                                  }).then((value) async {
                                    if (attachment) {
                                      //Notification Update
                                      await FirebaseFirestore.instance
                                        ...
                                        for (var i = 0;
                                          ...
                                          FirebaseFirestore.instance
                                            ...
                                            "notification":
                                                'Mr./Mrs. ${widget.teacherName} posted Quiz ${quizNoController.text} of ${widget.subjectName}',
                                          }).then((_) {
