  ...
  Future _selectDateTime(BuildContext context) async {
    ...
    setState(() {
      ...
      dueDateController.text =
          DateFormat('dd-MM-yyyy hh:ss a').format(dateTime);
    });
  }
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            try {
                              await FirebaseFirestore.instance
                                ...
                                'type': 'attendance',
                                'date': DateFormat('dd-MM-yyyy hh:ss a')
                                    .format(DateTime.now()),
                                ...
                                await FirebaseFirestore.instance
                                  ...
                                  await FirebaseFirestore.instance
                                      ...
                                      .doc(widget.subjectCode)
                                      .update({
                                    'totalClasses': value['totalClasses'] + 1
                                  }).then((value) async {
                                    await FirebaseFirestore.instance
                                        .collection('users')
                                        .get()
                                      ...
                                      for (var i = 0;
                                        ...
                                        FirebaseFirestore.instance
                                          ...
                                          "notification":
                                              'Mr./Mrs ${widget.teacherName} posted an Attendance in ${widget.subjectName}',
                                        }).then((_) {
                                          Get.back();
                                          Get.back();
                                          Get.snackbar(
